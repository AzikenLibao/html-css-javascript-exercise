// A tiny image gallery for Project 3.
// Swap these URLs for your own project screenshots later.
const images = [
  "https://via.placeholder.com/900x500?text=Project+3+Screenshot+1",
  "https://via.placeholder.com/900x500?text=Project+3+Screenshot+2",
  "https://via.placeholder.com/900x500?text=Project+3+Screenshot+3",
];
